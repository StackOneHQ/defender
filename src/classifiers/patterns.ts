...
export const INSTRUCTION_OVERRIDE_PATTERNS: PatternDefinition[] = [
    ...
    },
    {
        ...
        pattern:
            /disregard\s+(all\s+)?(previous|prior|earlier|above)\s+(instructions?|prompts?|rules?)/gi,
        category: 'instruction_override',
        severity: 'high',
...
export const SECURITY_BYPASS_PATTERNS: PatternDefinition[] = [
    ...
    },
    {
        id: 'ignore_safety',
        pattern:
            /ignore\s+(the\s+)?(safety|security|ethical)\s+(guidelines?|rules?|restrictions?)/gi,
        category: 'security_bypass',
        severity: 'high',
...
export const PROMPT_LEAKING_PATTERNS: PatternDefinition[] = [
    ...
    },
    {
        ...
        pattern:
            /show\s+(?:me\s+)?(?:your\s+)?(?:(?:initial|original|system|hidden)\s+)?instructions?/gi,
        category: 'instruction_override',
        severity: 'high',
    ...
    },
    {
        ...
        pattern:
            /what\s+(are|were)\s+(your|the)\s+(?:(?:initial|original|system)\s+)?instructions?/gi,
        category: 'instruction_override',
        severity: 'medium',
