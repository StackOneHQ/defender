 ...
 */
export function removePatterns(text: string, config: Partial<PatternRemoverConfig> = {}): PatternRemovalResult {
	if (!text) {
 ...
 */
export function removeInstructionOverrides(text: string, replacement: string = "[REDACTED]"): PatternRemovalResult {
	if (!text) {
		return { text, patternsRemoved: [], replacementCount: 0 };
	}
 ...
 */
export function removeRoleAssumptions(text: string, replacement: string = "[REDACTED]"): PatternRemovalResult {
	if (!text) {
		return { text, patternsRemoved: [], replacementCount: 0 };
	}
 ...
 */
export function removeSecurityBypasses(text: string, replacement: string = "[REDACTED]"): PatternRemovalResult {
	if (!text) {
		return { text, patternsRemoved: [], replacementCount: 0 };
	}
 ...
 */
export function removeCommandExecutions(text: string, replacement: string = "[REDACTED]"): PatternRemovalResult {
	if (!text) {
		return { text, patternsRemoved: [], replacementCount: 0 };
	}
